...
//		// si tiene orientacion positiva es mayor a 0 el area
//		System.out.println("getArea(puntoA, puntoB, puntoC)" +getArea(puntoA, puntoB, puntoC));
//		
//		System.out.println(">0 getArea(puntoA, puntoB, puntoSol)" +getArea(puntoA, puntoB, puntoSol));
//		System.out.println(">0 getArea(puntoB, puntoC, puntoSol)" +getArea(puntoB, puntoC, puntoSol));
//		System.out.println(">0 getArea(puntoC, puntoA, puntoSol)" +getArea(puntoC, puntoA, puntoSol));
//		
//		System.out.println("<0 getArea(puntoA, puntoB, puntoSol)" +getArea(puntoA, puntoB, puntoSol));
//		System.out.println("<0 getArea(puntoB, puntoC, puntoSol)" +getArea(puntoB, puntoC, puntoSol));
//		System.out.println("<0 getArea(puntoC, puntoA, puntoSol)" +getArea(puntoC, puntoA, puntoSol));
